...
BEGIN
    ...
    ('SILVER',     1,  5.00, 5000000,  0,  N'Hội viên bạc',       N'Silver Member',     '#9E9E9E',
     N'["Giảm 5% mọi đặt phòng","Ưu tiên đặt phòng"]',
     N'["5% off every booking","Priority reservation"]'),
    ('GOLD',       2, 10.00, 15000000, 0,  N'Hội viên vàng',      N'Gold Member',       '#FFC107',
     N'["Giảm 10% mọi đặt phòng","Check-in sớm"]',
     N'["10% off every booking","Early check-in"]'),
    ('DIAMOND',    3, 15.00, 30000000, 0,  N'Hội viên kim cương', N'Diamond Member',    '#00BCD4',
    ...
    ('VIP',        4, 20.00, 60000000, 0,  N'Hội viên VIP',       N'VIP Member',        '#9C27B0',
...
SET min_booking_count = 0
WHERE tier_code IN ('FIRST_TIME', 'SILVER', 'GOLD', 'DIAMOND', 'VIP');
GO
