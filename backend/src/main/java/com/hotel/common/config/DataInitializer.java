...
public class DataInitializer implements CommandLineRunner {
        ...
        private void seedMembershipTiers() {
                ...
                membershipTierRepository.save(MembershipTier.builder()
                                ...
                                .colorCode("#FFC107")
                                .benefitsVi("[\"Giảm 10% mọi đặt phòng\",\"Check-in sớm\"]")
                                .benefitsEn("[\"10% off every booking\",\"Early check-in\"]")
                                .build());
        ...
        private void seedHolidayPeriods() {
                if (holidayPeriodRepository.count() > 0)
                        return;
        ...
        private void seedGroupDiscountRules() {
                if (groupDiscountRuleRepository.count() > 0)
                        return;
                ...
                groupDiscountRuleRepository.save(GroupDiscountRule.builder()
                                .minGuests(10).maxGuests(null).discountPct(new BigDecimal("15.00")).isActive(true)
                                .build());
