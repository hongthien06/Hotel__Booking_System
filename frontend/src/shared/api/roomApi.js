...
export const getAvailableRoomsApi = async (checkIn, checkOut, province, minPrice, maxPrice, typeName, bedTypes) => {
  ...
  if (bedTypes && bedTypes.length > 0) params.bedTypes = bedTypes.join(',');
